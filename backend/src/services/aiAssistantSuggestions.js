...
const ROLE_SUGGESTIONS = {
  ...
  admin: [
    "How many devices in my branch are sending screenshots?",
    "What is the latest USB and DLP activity in my branch?",
  ...
  employee: [
    "How many of my devices are sending screenshots?",
    "What is my latest USB activity?",
