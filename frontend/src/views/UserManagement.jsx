                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        {item.status === "Active" ? (
                          ...
                          <button
                            type="button"
                            disabled
                            className="cursor-not-allowed rounded-xl border border-slate-200 bg-slate-100 px-3 py-2 text-xs font-black text-slate-400"
                            title="Reactivate this account before resetting its password"
                            aria-label="Password reset unavailable while account is inactive"
                          >
                            <KeyRound size={14} />
                          </button>
                        )}
