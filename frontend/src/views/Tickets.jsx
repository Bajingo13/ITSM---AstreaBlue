...
<div className="astrea-modal-backdrop z-[80]">
      <div className="astrea-modal-panel flex w-full max-w-3xl flex-col bg-slate-50 border-2 border-blue-200 rounded-3xl shadow-2xl overflow-hidden">
                    ...
                    <button
                      ...
                      className={`rounded-xl border-2 px-4 py-3 text-sm font-black transition ${
                        selectedStatus === col.id
                          ? "border-blue-600 bg-blue-600 text-white shadow-md disabled:opacity-100"
                          : "border-blue-200 bg-blue-50 text-blue-800 hover:border-blue-400 hover:bg-blue-100 disabled:opacity-50"
            ...
            <section className="rounded-2xl border border-blue-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-6 flex gap-3">
                ...
                <button
                  ...
                  className="rounded-xl bg-blue-600 px-6 py-3 font-bold text-white shadow-md transition hover:bg-blue-700 disabled:opacity-50 disabled:shadow-none"
                >
