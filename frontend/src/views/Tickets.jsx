...
<div className="astrea-modal-backdrop z-[80]">
      <div className="astrea-modal-panel flex w-full max-w-3xl flex-col bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="flex-1 space-y-8 overflow-y-auto p-8 pb-28">
            ...
            <section className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="astrea-card p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md">
            ...
            <section className="astrea-card p-6 shadow-sm">
